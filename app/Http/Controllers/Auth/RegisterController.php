...
class RegisterController extends Controller
{
    ...
    */
    ...
    public function registerView()
    {
        ...
        $years = CarbonPeriod::start('2000-01-01')->untilNow()->years()->toArray();
        $months = CarbonPeriod::start('2000-01-01')->untilNow()->months()->toArray();
        $days = CarbonPeriod::start('2000-01-01')->untilNow()->days()->toArray();
